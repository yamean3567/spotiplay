...
const Home = () => {
    ...
    return (
        <div className="h-screen flex flex-col justify-center items-center bg-black bg-gradient-to-t from-gray-900 to-black">
            ...
            <div className="md:w-1/3 bg-white grid justify-center px-8 pt-8 pb-8 text-white rounded-xl bg-gradient-to-t from-green-900 to-black-300">
                <div className="mb-8 text-center font-bold text-white text-2xl">
                    Spotiplay
                </div>
