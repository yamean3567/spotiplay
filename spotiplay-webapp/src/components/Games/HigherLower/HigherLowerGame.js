                ...
                <div className="flex flex-col md:flex-col">
                    ...
                    <div className="flex-1 text-center grid-cols-1 grid object-contain md:flex-1 md:text-center md:h-24 md:grid-cols-1 md:gap-y-1 md:mt-10"> <b>{props.track2}</b>by <b>{props.artist2}</b> is
                        ...
                        <div className="mb-4 text-center mx-auto py-2 flex flex-col gap-y-2">
                            <button className="p-3 border-2 rounded-lg w-24 h-22 border-green-800 hover:bg-green-600" disabled={props.loading} onClick={() => props.higher(props.id1, props.id2, props.tracks)}> Higher </button>
                            <button className="p-3 border-2 rounded-lg w-24 h-22 border-gray-800 hover:bg-gray-600" disabled={props.loading} onClick={() => props.lower(props.id1, props.id2, props.tracks)}> Lower </button>
                        </div>
                        <br/>
