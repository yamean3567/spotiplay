            ...
            <div className='flex flex-col h-full flex-grow'>
                ...
                <div className="flex flex-row">
                    ...
                    <div className="grid gap-y-2 place-items-center text-center p-2 inset-y-2 right-2 flex-grow text-xl "> <nobr><b>{props.track2}</b> by <b>{props.artist2}</b> is</nobr> 
                        <div><button className="p-3 border-2 rounded-lg w-24 h-22 border-green-800 hover:bg-green-600" onClick={() => props.higher(props.id1, props.id2, props.tracks)}> Higher </button></div>
                        <div><button className="p-3 border-2 rounded-lg w-24 h-22 border-gray-800 hover:bg-gray-600" onClick={() => props.lower(props.id1, props.id2, props.tracks)}> Lower </button></div>
                        <nobr>on the US chart than <b>{props.track1}</b> by <b>{props.artist1}</b></nobr>
                    </div>
