...
const DisplayLeaderboard = (props) => {
    ...
    return (
        <div className="grid place-items-center">
            ...
            <img className={wide ? "fixed bottom-0 right-10 w-1/6 ..." : "fixed invisible"} alt="gif" src="https://i.gifer.com/X11G.gif"/>
            <img className={wide ? "fixed bottom-0 left-0 w-1/4 ..." : "fixed invisible"} alt="gif" src="https://www.pikpng.com/pngl/b/188-1882327_biggie-smalls-png-clipart.png"/>
            {/*<img className="absolute bottom-0 right-0 h-2/4 w-1/4 ..." alt="gif" src="https://i.imgur.com/kQySfCM.gif"/>*/}
            <div id="tab-contents">
